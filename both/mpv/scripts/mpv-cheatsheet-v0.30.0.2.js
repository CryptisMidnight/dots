...
var shortcuts = [
  ...
  {
    category: 'Shader keys', // Anime4K upscaler  https://github.com/bloc97/Anime4K
    shortcuts: [
      {keys: '[Ctrl] 0', effect: 'Clear shaders, reset to default'},
      {keys: '[Ctrl] 1', effect: 'Anime4K: Mode A'},
      {keys: '[Ctrl] 2', effect: 'Anime4K: Mode B'},
      {keys: '[Ctrl] 3', effect: 'Anime4K: Mode C'},
      {keys: '[Ctrl] 4', effect: 'Anime4K: Mode A+A'},
      {keys: '[Ctrl] 5', effect: 'Anime4K: Mode B+B'},
      {keys: '[Ctrl] 6', effect: 'Anime4K: Mode C+A'},
    ]
  },
]
