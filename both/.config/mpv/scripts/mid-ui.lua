...
local user_opts = {
    ...
    -- UI color codes (BBGGRR)
    seekbar_bg = "ffffff",              -- background color of the main bar
    seekbar_fg = "ffffff",              -- foreground color of the main bar
    volumebar_bg = "ffffff",            -- background color of the volume bar
    volumebar_fg = "ffffff",            -- foreground color of the volume bar
    button = "ffffff",                  -- the color of misc buttons
    winbut = "ffffff",                  -- window control button color
    playbut = "ffffff",                 -- play button color
    pausebut = "ffffff",                -- puase button color
    skip_but = "ffffff",                -- the skip button color
    vol_low = "ffffff",                 -- =< 33% volume color
    vol_medium = "ffffff",              -- 34% - 66% volume color
    vol_high = "ffffff",                -- 67% - 100% volume color
    vol_over = "ffffff",                -- > 100% volume color
    vol_mute = "ffffff",                -- volume mute color
}

-- read options from config and command-line
opt.read_options(user_opts, "mid", function(list) update_options(list) end)
...
local osc_styles = {
    box = '{\\blur60\\bord0\\1c&H101010\\3c&H101010}',
    seekbar_bg = '{\\blur0\\bord0\\1c&H'.. user_opts.seekbar_bg ..'}',
    seekbar_fg = '{\\blur0\\bord0\\1c&H'.. user_opts.seekbar_fg ..'}',
    volumebar_bg = '{\\blur0\\bord0\\1c&H'.. user_opts.volumebar_bg ..'}',
    volumebar_fg = '{\\blur0\\bord0\\1c&H'.. user_opts.volumebar_fg ..'}',
    button = '{\\blur0\\bord0\\1c&H'.. user_opts.button ..'\\3c&H999999}',
    winbut = '{\\blur0\\bord0\\1c&H'.. user_opts.winbut ..'\\3c&H999999}',
    timecode = '{\\blur0\\bord0\\1c&He0e0e0\\3c&H000000\\fs18}',
    tooltip = '{\\blur1.5\\bord0.01\\1c&He0e0e0\\3c&H000000\\fs18}',
    title = '{\\blur0\\bord0\\1c&He0e0e0\\fs18}',
}
...
local icons = {
    play = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.playbut ..'}m 0 0 m 24 24 m 8 5 l 8 19 l 19 12{\\p0}',
    pause = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.pausebut ..'}m 0 0 m 24 24 m 6 19 l 10 19 l 10 5 l 6 5 l 6 19 m 14 5 l 14 19 l 18 19 l 18 5 l 14 5{\\p0}',
    ...
    skipback = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.skip_but ..'}m 0 0 m 24 24 m 11 18 l 11 6 l 2.5 12 l 11 18 m 11.5 12 l 20 18 l 20 6 l 11.5 12{\\p0}',
    skipfrwd = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.skip_but ..'}m 0 0 m 24 24 m 4 18 l 12.5 12 l 4 6 l 4 18 m 13 6 l 13 18 l 21.5 12 l 13 6{\\p0}',
    volume_low = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.vol_low ..'}m 0 0 m 24 24 m 3 9 l 3 15 l 7 15 l 12 20 l 12 4 l 7 9 l 3 9{\\p0}',
    volume_medium = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.vol_medium ..'}m 0 0 m 24 24 m 14 7.97 l 14 16.02 b 15.48 15.29 16.5 13.77 16.5 12 b 16.5 10.23 15.48 8.71 14 7.97 m 3 9 l 3 15 l 7 15 l 12 20 l 12 4 l 7 9 l 3 9{\\p0}',
    volume_high = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.vol_high ..'}m 0 0 m 24 24 m 3 9 l 3 15 l 7 15 l 12 20 l 12 4 l 7 9 l 3 9 m 16.5 12 b 16.5 10.23 15.48 8.71 14 7.97 l 14 16.02 b 15.48 15.29 16.5 13.77 16.5 12 m 14 3.23 l 14 5.29 b 16.89 6.15 19 8.83 19 12 b 19 15.17 16.89 17.85 14 18.71 l 14 20.77 b 18.01 19.86 21 16.28 21 12 b 21 7.72 18.01 4.14 14 3.23{\\p0}',
    volume_over = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.vol_over ..'}m 0 0 m 24 24 m 3 9 l 3 15 l 7 15 l 12 20 l 12 4 l 7 9 l 3 9 m 16 6 l 18 6 l 18 14 l 16 14 m 16 16 l 18 16 l 18 18 l 16 18{\\p0}',
    volume_mute = '{\\p1\\blur1.5\\bord0.01\\1c&H'.. user_opts.vol_mute ..'}m 0 0 m 24 24 m 16.5 12 b 16.5 10.23 15.48 8.71 14 7.97 l 14 10.18 l 16.45 12.63 b 16.48 12.43 16.5 12.22 16.5 12 m 19 12 b 19 12.94 18.8 13.82 18.46 14.64 l 19.97 16.15 b 20.63 14.91 21 13.5 21 12 b 21 7.72 18.01 4.14 14 3.23 l 14 5.29 b 16.89 6.15 19 8.83 19 12 m 4.27 3 l 3 4.27 l 7.73 9 l 3 9 l 3 15 l 7 15 l 12 20 l 12 13.27 l 16.25 17.52 b 15.58 18.04 14.83 18.45 14 18.7 l 14 20.76 b 15.38 20.45 16.63 19.81 17.69 18.95 l 19.73 21 l 21 19.73 l 12 10.73 l 4.27 3 m 12 4 l 9.91 6.09 l 12 8.18 l 12 4{\\p0}',
}
...
local window_control_box_width = 100
...
function window_controls()
    ...
    local first_geo =
        {x = controlbox_left + 15, y = button_y, an = 5, w = 28, h = wc_geo.h}
    local second_geo =
        {x = controlbox_left + 45, y = button_y, an = 5, w = 28, h = wc_geo.h}
    local third_geo =
        {x = controlbox_left + 75, y = button_y, an = 5, w = 28, h = wc_geo.h}
    ...
    local titY = osc_param.playresy - 17
    local titH = 30
    local left_pad = 16
    local right_pad = 8
    ...
    lo.style = string.format("%s{\\clip(%f,%f,%f,%f)}",
        osc_styles.title,
        titlebox_left, titY - titH,
        titlebox_right , titY + titH)
...
function layouts()
    ...
    lo.geometry = {x = refX, y = refY - 60, an = 5, w = osc_geo.w - 40, h = 16}
    ...
    lo.slider.bg_alpha = 105
    lo.slider.tooltip_style = osc_styles.tooltip

    -- Volumebar
    lo = add_layout("volumebar")
    lo.geometry = {x = 205, y = btnY, an = 4, w = 80, h = btnH}
    lo.style = osc_styles.volumebar_fg
    lo.slider.gap = 3
    lo.slider.pad = -10
    lo.slider.handle_size = 10
    lo.slider.bar_height = 3
    lo.slider.bg_style = osc_styles.volumebar_bg
    lo.slider.bg_alpha = 95
    lo.slider.tooltip_style = osc_styles.tooltip
    lo.slider.adjust_tooltip = false

    -- times
    lo = add_layout('tc_left')
    lo.geometry = {x = 30, y = btnY - 30, an = 7, w = 64, h = 15}
    lo.style = osc_styles.timecode	
	
    lo = add_layout('tc_right')
    lo.geometry = {x = osc_geo.w - 30, y = btnY - 30, an = 9, w = 64, h = 15}
    lo.style = osc_styles.timecode	

    -- buttons
    lo = add_layout("pl_prev")
    lo.geometry = {x = 30, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("skipback")
    lo.geometry = {x = 60, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("playpause")
    lo.geometry = {x = 90, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("skipfrwd")
    lo.geometry = {x = 120, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("pl_next")
    lo.geometry = {x = 150, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("cy_audio")
    lo.geometry = {x = osc_geo.w - 90, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("cy_sub")
    lo.geometry = {x = osc_geo.w - 120, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button
    ...
    lo.geometry = {x = 185, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("tog_fs")
    lo.geometry = {x = osc_geo.w - 30, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("tog_info")
    lo.geometry = {x = osc_geo.w - 60, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button
end
